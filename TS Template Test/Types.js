...
var multiplyNumbers = function (number1, number2) { return number1 * number2; }; //Exmaple of arrow function
...
// Rest and Spread
var numbersTwo = [1, 10, 99, -5];
console.log(Math.max(33, 99, 10, -3, 22));
console.log(Math.max.apply(Math, numbersTwo)); //... Spread. Acts to essentially remove the square brackets and grab the list of numbers since we cant call numbers directly in Math.macx()
...
var hobby1 = myHobbies[0], hobby2 = myHobbies[1]; //Does the same thing as above, creates new vars and assigns them as desired in less code
console.log(hobby1, hobby2);
var userInfo = { userName: "Max", age: 27 }; //Not just for arrays, also works for objects
var userName = userInfo.userName, age = userInfo.age;
console.log(userName, age);
// Template Literals
var userFullName = "Max";
